...
- **mediastore**: 10 UMEs: Interface: IPackaging, Interface: IDownload, Interface: IUserManagement, Component: Cache, Component: AudioWatermarking, Interface: IUserDB, Interface: IDB, Interface: IMediaManagement, Interface: IFacade, Interface: IMediaAccess
- **teastore**: 13 UMEs: Component: PopularityBasedRecommender, Component: OrderBasedRecommender, Interface: Persistence, Interface: LoadBalancer, Interface: AuthCart, Component: DummyRecommender, Interface: ProductActions, Interface: Recommender, Interface: RecommenderStrategy, Interface: ImageProvider, Component: PreprocessedSlopeOneRecommender, Interface: CartActions, Component: SlopeOneRecommender
- **teammates**: 7 UMEs: Interface: Common, Interface: E2E, Interface: UI, Interface: Test Driver, Interface: Logic, Interface: Storage, Interface: Client
- **bigbluebutton**: 12 UMEs: Interface: FSESL, Interface: Presentation Conversion, Interface: Apps, Interface: HTML5 Server, Interface: WebRTC-SFU, Interface: Redis PubSub, Interface: HTML5 Client, Interface: FreeSWITCH, Interface: BBB web, Component: Recording Service, Interface: Recording Service, Interface: Redis DB
...
| Sentence | Directory | Expanded Files |
|----------|-----------|----------------|
| 85 | `src/main/java/teammates/ui/` | 235 |
...
| 6 | Interface: IFacade | Interface | 3 |
| 7 | Interface: IPackaging | Interface | 3 |
| 8 | Component: AudioWatermarking | Component | 3 |
| 9 | Interface: IMediaManagement | Interface | 3 |
| 10 | Interface: IUserDB | Interface | 3 |
| 11 | Component: MediaAccess | Component | 2 |
| 12 | Component: UserDBAdapter | Component | 2 |
| 13 | Interface: IDB | Interface | 2 |
| 14 | Component: UserManagement | Component | 2 |
| 15 | Component: Reencoding | Component | 1 |
| 16 | Component: Facade | Component | 1 |
| 17 | Component: TagWatermarking | Component | 1 |
| 18 | Component: Packaging | Component | 1 |
| 19 | Component: MediaManagement | Component | 1 |
...
| 7 | Component: DummyRecommender | Component | 2 |
| 8 | Interface: AuthCart | Interface | 2 |
| 9 | Component: PreprocessedSlopeOneRecommender | Component | 2 |
| 10 | Component: SlopeOneRecommender | Component | 2 |
| 11 | Component: OrderBasedRecommender | Component | 2 |
| 12 | Component: PopularityBasedRecommender | Component | 2 |
| 13 | Interface: ImageProvider | Interface | 1 |
| 14 | Interface: Recommender | Interface | 1 |
| 15 | Interface: ProductActions | Interface | 1 |
| 16 | Interface: Persistence | Interface | 1 |
| 17 | Interface: LoadBalancer | Interface | 1 |
| 18 | Interface: CartActions | Interface | 1 |
| 19 | Interface: RecommenderStrategy | Interface | 1 |

**teammates**:

| Rank | Element | Type | Files |
|------|---------|------|-------|
| 1 | Interface: UI | Interface | 348 |
| 2 | Component: UI | Component | 348 |
...
| Rank | Element | Type | Files |
|------|---------|------|-------|
| 1 | Component: FreeSWITCH | Component | 94 |
| 2 | Interface: FreeSWITCH | Interface | 94 |
| 3 | Component: FSESL | Component | 92 |
| 4 | Interface: FSESL | Interface | 92 |
| 5 | Component: Presentation Conversion | Component | 70 |
| 6 | Interface: Presentation Conversion | Interface | 70 |
| 7 | Interface: BBB web | Interface | 33 |
| 8 | Component: BBB web | Component | 33 |
| 9 | Interface: HTML5 Client | Interface | 16 |
| 10 | Component: HTML5 Client | Component | 16 |
...
| 19 | Interface: WebRTC-SFU | Interface | 6 |
| 20 | Component: WebRTC-SFU | Component | 6 |
...
| teastore | Component: Persistence | 6 | `DatabaseGenerationEndpoint.java` | 6 |
| teammates | Component: Logic | 15 | `EmailSenderTest.java` | 19 |
| bigbluebutton | Component: HTML5 Client | 14 | `opts-jammy.sh` | 20 |
| jabref | Component: model | 6 | `BibDatabaseModeDetection.java` | 6 |
