...
| 3 | bigbluebutton | Component: HTML5 Server | `bbb-html5-nodejs/build.sh` | 12 | 0 | **12** | 12 |
| 4 | bigbluebutton | Component: HTML5 Server | `bbb-graphql-server/after-install.sh` | 12 | 0 | **12** | 12 |
| 5 | bigbluebutton | Component: HTML5 Server | `bbb-graphql-server/after-remove.sh` | 12 | 0 | **12** | 12 |
| 6 | bigbluebutton | Component: HTML5 Server | `bbb-graphql-server/install-hasura.sh` | 12 | 0 | **12** | 12 |
| 7 | bigbluebutton | Component: HTML5 Server | `bbb-graphql-server/before-remove.sh` | 12 | 0 | **12** | 12 |
| 8 | bigbluebutton | Component: HTML5 Server | `bbb-graphql-server/build.sh` | 12 | 0 | **12** | 12 |
...
| 11 | bigbluebutton | Component: HTML5 Client | `client/run.sh` | 4 | 0 | **4** | 4 |
...
| 14 | bigbluebutton | Component: HTML5 Client | `bbb-graphql-client-test/deploy.sh` | 4 | 0 | **4** | 4 |
...
| 21 | bigbluebutton | Component: Recording Service | `service/ValidationService.java` | 0 | 0 | **0** | 0 |
...
| 24 | bigbluebutton | Component: Recording Service | `service/ServiceUtils.java` | 0 | 0 | **0** | 0 |
...
|------|---------|--------------|-----------------|-------------------|
| 1 | bigbluebutton | Component: BBB web | `pres-checker/run.sh` | **3** |
| 2 | bigbluebutton | Component: BBB web | `bigbluebutton-web/gradlew` | **3** |
| 3 | bigbluebutton | Component: BBB web | `api/ParamsProcessorUtilTest.java` | **3** |
...
| 6 | bigbluebutton | Component: BBB web | `pres-checker/build.sh` | **3** |
| 7 | bigbluebutton | Component: BBB web | `messaging/NullMessagingService.java` | **3** |
| 8 | bigbluebutton | Component: BBB web | `bigbluebutton-web/run.sh` | **3** |
| 9 | bigbluebutton | Component: BBB web | `bigbluebutton-web/run-dev.sh` | **3** |
| 10 | bigbluebutton | Component: BBB web | `bigbluebutton-web/deploy_to_usr_share.sh` | **3** |
| 11 | bigbluebutton | Component: BBB web | `prescheck/Main.java` | **3** |
...
|------|---------|--------------|------------------|-------------|-------------|-----------|
| 1 | teammates | Component: Logic | `core/FeedbackResponseCommentsLogic.java` | **17** | 4 | 0.810 |
| 2 | teammates | Component: Logic | `core/FeedbackSessionsLogic.java` | **17** | 4 | 0.810 |
| 3 | teammates | Component: Logic | `core/DeadlineExtensionsLogic.java` | **17** | 4 | 0.810 |
| 4 | teammates | Component: Logic | `api/UserProvision.java` | **17** | 4 | 0.810 |
| 5 | teammates | Component: Logic | `api/EmailGenerator.java` | **17** | 4 | 0.810 |
| 6 | teammates | Component: Logic | `api/EmailSender.java` | **17** | 4 | 0.810 |
| 7 | teammates | Component: Logic | `core/LogicStarter.java` | **17** | 4 | 0.810 |
...
| 10 | teammates | Component: Logic | `core/package-info.java` | **17** | 4 | 0.810 |
| 11 | teammates | Component: Logic | `core/StudentsLogic.java` | **17** | 4 | 0.810 |
| 12 | teammates | Component: Logic | `api/package-info.java` | **17** | 4 | 0.810 |
| 13 | teammates | Component: Logic | `api/LogsProcessor.java` | **17** | 4 | 0.810 |
| 14 | teammates | Component: Logic | `core/FeedbackQuestionsLogic.java` | **17** | 4 | 0.810 |
| 15 | teammates | Component: Logic | `api/Logic.java` | **17** | 4 | 0.810 |
| 16 | teammates | Component: Logic | `core/NotificationsLogic.java` | **17** | 4 | 0.810 |
| 17 | teammates | Component: Logic | `api/TaskQueuer.java` | **17** | 4 | 0.810 |
| 18 | teammates | Component: Logic | `api/RecaptchaVerifier.java` | **17** | 4 | 0.810 |
| 19 | teammates | Component: Logic | `core/DataBundleLogic.java` | **17** | 4 | 0.810 |
| 20 | teammates | Component: Logic | `core/CoursesLogic.java` | **17** | 4 | 0.810 |
...
| teammates | Component: Client | `scripts/TeamEvalResultCalculations.java` | 3 | 5 | 0.375 | 5 SAD-SAM FPs for Component: Client |
...
| teammates | Component: Client | `scripts/DataMigrationForSanitizedDataInCourseAttributes.java` | 3 | 5 | 0.375 | 5 SAD-SAM FPs for Component: Client |
...
| teammates | Component: Client | `scripts/DataMigrationForTextQuestionRecommendedLength.java` | 3 | 5 | 0.375 | 5 SAD-SAM FPs for Component: Client |
