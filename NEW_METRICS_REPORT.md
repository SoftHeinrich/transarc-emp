...
| SAD-CODE | V45+GoldSAMCODE | 0.979 | 0.780 | 0.868 | 46 | 1 | 13 |
...
| SAD-SAM | V45 | 26 | 1 | 5 | 671 | 703 | **0.894** | 0.919 |
| SAD-CODE | TransArc | 25 | 1 | 34 | 2086 | 2146 | **0.633** | 0.712 |
| SAD-CODE | V45+GoldSAMCODE | 46 | 1 | 13 | 2086 | 2146 | **0.871** | 0.890 |
...
| SAD-SAM | V45 | **0.815** | 0.815 | 0.889 | 0.111 | 0.852 |
| SAD-CODE | TransArc | **0.600** | 0.600 | 0.640 | 0.360 | 0.613 |
| SAD-CODE | V45+GoldSAMCODE | **0.800** | 0.800 | 0.840 | 0.160 | 0.827 |
...
| SAD-SAM | V45 | **0.852** | per-link [0.77–1.00] |
| SAD-CODE | TransArc | **0.613** | uniform (no confidence) |
| SAD-CODE | V45+GoldSAMCODE | **0.827** | inherited from component |
...
| V45+GoldSAMCODE | 0.868 | **0.885** | +0.017 | 23.0 | 1.0 | 5.0 |
...
| SAD-CODE | V45+GoldSAMCODE | 0.840 | 0.955 | **0.894** |
...
| SAD-CODE | V45+GoldSAMCODE | 0.981 | 1.000 | 0.990 | 707 | 14 | 0 |
...
| SAD-SAM | V45 | 27 | 1 | 0 | 789 | 817 | **0.981** | 0.999 |
| SAD-CODE | TransArc | 501 | 0 | 206 | 6001 | 6708 | **0.828** | 0.854 |
| SAD-CODE | V45+GoldSAMCODE | 707 | 14 | 0 | 5987 | 6708 | **0.989** | 0.999 |
...
| V45+GoldSAMCODE | 0.990 | **0.982** | -0.008 | 27.0 | 1.0 | 0.0 |
...
| SAD-CODE | V45+GoldSAMCODE | 1.000 | 0.958 | **0.979** |
...
| SAD-CODE | V45+GoldSAMCODE | 0.803 | 0.770 | 0.786 | 6235 | 1525 | 1862 |
...
| SAD-SAM | V45 | 50 | 11 | 7 | 2704 | 2772 | **0.845** | 0.937 |
| SAD-CODE | TransArc | 7307 | 2395 | 790 | 149492 | 159984 | **0.814** | 0.943 |
| SAD-CODE | V45+GoldSAMCODE | 6235 | 1525 | 1862 | 150362 | 159984 | **0.775** | 0.880 |
...
| SAD-SAM | V45 | **0.778** | 0.844 | 0.800 | 0.133 | 0.822 |
| SAD-CODE | TransArc | **0.370** | 0.554 | 0.413 | 0.391 | 0.493 |
| SAD-CODE | V45+GoldSAMCODE | **0.337** | 0.359 | 0.391 | 0.576 | 0.404 |
...
| SAD-CODE | V45+GoldSAMCODE | **0.402** | inherited from component |
...
| V45+GoldSAMCODE | 0.786 | **0.593** | -0.193 | 48.6 | 10.4 | 56.2 |
...
| SAD-CODE | V45+GoldSAMCODE | 0.424 | 0.766 | **0.546** |
...
| SAD-CODE | V45+GoldSAMCODE | 0.817 | 0.947 | 0.877 | 1448 | 325 | 81 |
...
| SAD-SAM | V45 | 52 | 9 | 10 | 1843 | 1914 | **0.840** | 0.917 |
| SAD-CODE | TransArc | 1287 | 282 | 242 | 22723 | 24534 | **0.820** | 0.915 |
| SAD-CODE | V45+GoldSAMCODE | 1448 | 325 | 81 | 22680 | 24534 | **0.871** | 0.966 |
...
| SAD-SAM | V45 | **0.708** | 0.792 | 0.854 | 0.062 | 0.832 |
| SAD-CODE | TransArc | **0.156** | 0.667 | 0.244 | 0.178 | 0.675 |
| SAD-CODE | V45+GoldSAMCODE | **0.867** | 0.911 | 0.889 | 0.067 | 0.910 |
...
| SAD-SAM | V45 | **0.866** | per-link [0.77–1.00] |
| SAD-CODE | TransArc | **0.725** | uniform (no confidence) |
| SAD-CODE | V45+GoldSAMCODE | **0.974** | inherited from component |
...
| V45+GoldSAMCODE | 0.877 | **0.886** | +0.009 | 47.0 | 8.1 | 4.0 |
...
| SAD-CODE | V45+GoldSAMCODE | 0.933 | 0.816 | **0.871** |
...
| SAD-SAM | V45 | **0.950** | per-link [0.77–1.00] |
| SAD-CODE | TransArc | **0.935** | uniform (no confidence) |
| SAD-CODE | V45+GoldSAMCODE | **0.933** | inherited from component |
...
|:--|:---:|:---:|:---:|:---:|
| mediastore | 0.694 | 0.897 | 0.588 | 0.868 |
| teastore | 0.851 | 0.982 | 0.829 | 0.990 |
| teammates | 0.710 | 0.847 | 0.821 | 0.786 |
| bigbluebutton | 0.793 | 0.846 | 0.831 | 0.877 |
| jabref | 0.947 | 0.947 | 0.943 | 0.944 |
| **Average** | **0.799** | **0.904** | **0.803** | **0.893** |
...
|:--|---:|---:|---:|:---:|:---:|:---:|
| mediastore | 19 | 37 | 703 | 0.711 | 0.894 | +0.184 |
| teastore | 19 | 43 | 817 | 0.857 | 0.981 | +0.124 |
| teammates | 14 | 198 | 2772 | 0.714 | 0.845 | +0.130 |
| bigbluebutton | 22 | 87 | 1914 | 0.792 | 0.840 | +0.048 |
| jabref | 6 | 13 | 78 | 0.933 | 0.933 | +0.000 |
| **Average** | | | | **0.801** | **0.899** | **+0.097** |

**SAD-CODE level:**

| Project | #Files | Universe | TransArc MCC | V45 MCC | Δ |
|:--|---:|---:|:---:|:---:|:---:|
| mediastore | 58 | 2146 | 0.633 | 0.871 | +0.238 |
| teastore | 156 | 6708 | 0.828 | 0.989 | +0.161 |
| teammates | 808 | 159984 | 0.814 | 0.775 | -0.039 |
| bigbluebutton | 282 | 24534 | 0.820 | 0.871 | +0.051 |
| jabref | 1956 | 25428 | 0.917 | 0.917 | +0.000 |
| **Average** | | | **0.802** | **0.885** | **+0.082** |
...
|:--|:---:|:---:|:---:|:---:|:---:|:---:|
| mediastore | 0.556 | 0.815 | 0.574 | 0.852 | 0.407 | 0.111 |
| teastore | 0.696 | 1.000 | 0.696 | 1.000 | 0.304 | 0.000 |
| teammates | 0.756 | 0.778 | 0.800 | 0.822 | 0.133 | 0.133 |
| bigbluebutton | 0.604 | 0.708 | 0.712 | 0.832 | 0.188 | 0.062 |
| jabref | 0.800 | 0.800 | 0.900 | 0.900 | 0.000 | 0.000 |
| **Average** | **0.682** | **0.820** | **0.736** | **0.881** | | |

**SAD-CODE level (file sets):**

| Project | TransArc EMR | V45 EMR | TransArc Jaccard | V45 Jaccard | TransArc Zero-Pred | V45 Zero-Pred |
|:--|:---:|:---:|:---:|:---:|:---:|:---:|
| mediastore | 0.600 | 0.800 | 0.613 | 0.827 | 0.360 | 0.160 |
| teastore | 0.696 | 1.000 | 0.696 | 1.000 | 0.304 | 0.000 |
| teammates | 0.370 | 0.337 | 0.493 | 0.404 | 0.391 | 0.576 |
| bigbluebutton | 0.156 | 0.867 | 0.675 | 0.910 | 0.178 | 0.067 |
| jabref | 0.500 | 0.800 | 0.918 | 0.918 | 0.000 | 0.000 |
| **Average** | **0.464** | **0.761** | **0.679** | **0.812** | | |
...
|:--|:---:|:---:|:---:|
| mediastore | 0.574 | 0.852 | +0.278 |
| teastore | 0.696 | 1.000 | +0.304 |
| teammates | 0.800 | 0.833 | +0.033 |
| bigbluebutton | 0.709 | 0.866 | +0.157 |
| jabref | 0.950 | 0.950 | +0.000 |
| **Average** | **0.746** | **0.900** | **+0.154** |

**SAD-CODE level:**

| Project | TransArc MAP | V45 MAP | Δ |
|:--|:---:|:---:|:---:|
| mediastore | 0.613 | 0.827 | +0.213 |
| teastore | 0.696 | 1.000 | +0.304 |
| teammates | 0.514 | 0.402 | -0.112 |
| bigbluebutton | 0.725 | 0.974 | +0.248 |
| jabref | 0.935 | 0.933 | -0.002 |
| **Average** | **0.697** | **0.827** | **+0.130** |
...
|:--|:---:|:---:|:---:|:---:|:---:|:---:|
| mediastore | 0.588 | 0.739 | +0.151 | 0.868 | 0.885 | +0.017 |
| teastore | 0.829 | 0.851 | +0.022 | 0.990 | 0.982 | -0.008 |
| teammates | 0.821 | 0.624 | -0.197 | 0.786 | 0.593 | -0.193 |
| bigbluebutton | 0.831 | 0.347 | -0.484 | 0.877 | 0.886 | +0.009 |
| jabref | 0.943 | 0.857 | -0.086 | 0.944 | 0.947 | +0.004 |
| **Average** | **0.803** | **0.684** | **-0.119** | **0.893** | **0.859** | **-0.034** |
...
|:--|:---:|:---:|:---:|:---:|:---:|:---:|
| mediastore | 0.148 | 1.000 | 0.588 | **0.516** | 0.868 | **0.845** |
| teastore | 0.120 | 1.000 | 0.829 | **0.806** | 0.990 | **0.989** |
| teammates | 0.055 | 0.881 | 0.821 | **0.927** | 0.786 | **0.885** |
| bigbluebutton | 0.054 | 0.968 | 0.831 | **0.850** | 0.877 | **0.901** |
...
|:--|:---:|:---:|:---:|:---:|:---:|:---:|
| mediastore | 0.593 | 0.941 | **0.727** | 0.889 | 0.960 | **0.923** |
| teastore | 0.696 | 1.000 | **0.821** | 1.000 | 0.958 | **0.979** |
| teammates | 0.844 | 0.530 | **0.651** | 0.867 | 0.766 | **0.813** |
| bigbluebutton | 0.812 | 0.878 | **0.844** | 0.938 | 0.820 | **0.875** |
...
| Project | TransArc Coverage | TransArc Purity | TransArc HUS | V45 Coverage | V45 Purity | V45 HUS |
|:--|:---:|:---:|:---:|:---:|:---:|:---:|
| mediastore | 0.640 | 0.941 | **0.762** | 0.840 | 0.955 | **0.894** |
| teastore | 0.696 | 1.000 | **0.821** | 1.000 | 0.958 | **0.979** |
| teammates | 0.598 | 0.585 | **0.591** | 0.424 | 0.766 | **0.546** |
| bigbluebutton | 0.822 | 0.268 | **0.405** | 0.933 | 0.816 | **0.871** |
...
|:--|:--|:---:|:---:|:---:|:---:|:--|
| F1 (standard) | SAD-SAM | 0.799 | 0.904 | +0.105 | V45 | Basic quality at component level |
| F1 (standard) | SAD-CODE | 0.803 | 0.893 | +0.090 | V45 | File-level (enrollment-inflated) |
| **N1: MCC** | SAD-SAM | 0.801 | 0.899 | +0.097 | V45 | Discrimination (component) |
| **N1: MCC** | SAD-CODE | 0.802 | 0.885 | +0.082 | V45 | Discrimination (file) |
| **N2: EMR** | SAD-SAM | 0.682 | 0.820 | +0.138 | V45 | Exact component-set per sentence |
| **N2: EMR** | SAD-CODE | 0.464 | 0.761 | +0.297 | V45 | Exact file-set per sentence |
| **N3: MAP** | SAD-SAM | 0.746 | 0.900 | +0.154 | V45 | Ranking quality (component) |
| **N3: MAP** | SAD-CODE | 0.697 | 0.827 | +0.130 | V45 | Ranking quality (file) |
| **N4: ACF1** | SAD-CODE | 0.684 | 0.859 | +0.175 | V45 | Enrollment-corrected file-level |
| **N5: NDG** | SAD-CODE | 0.803 | 0.907 | +0.104 | V45 | Intelligence over random baseline |
| **N6: HUS** | SAD-SAM | 0.786 | 0.896 | +0.109 | V45 | Coverage × purity (component) |
| **N6: HUS** | SAD-CODE | 0.649 | 0.836 | +0.187 | V45 | Coverage × purity (file) |
