...
| B13: Gold-Density | 1,200 | **0.079** | 0.078 | 1.000 (25/25) | 0.000 | 0.958 | 23.00 |
...
| B9: Round-Robin | 291 | **0.030** | 0.024 | 0.087 (2/23) | 0.087 | 0.913 | 18.40 |
| B10: Sent-Length | 291 | **0.134** | 0.055 | 0.174 (4/23) | 0.174 | 0.826 | 3.34 |
...
| B13: Gold-Density | 2,346 | **0.310** | 0.275 | 1.000 (23/23) | 0.130 | 0.798 | 3.96 |
...
| B10: Sent-Length | 11,080 | **0.064** | 0.030 | 0.120 (11/92) | 0.043 | 0.957 | 17.10 |
...
| B13: Gold-Density | 38,272 | **0.178** | 0.141 | 0.891 (82/92) | 0.033 | 0.892 | 8.25 |
...
| B10: Sent-Length | 1,554 | **0.147** | 0.109 | 0.111 (5/45) | 0.111 | 0.891 | 5.88 |
| B11: Optimal-Const (Component: HTML5 Server) | 720 | **0.285** | 0.416 | 0.444 (20/45) | 0.444 | 0.556 | 1.25 |
...
| B13: Gold-Density | 9,990 | **0.460** | 0.344 | 1.000 (10/10) | 0.400 | 0.580 | 1.38 |
...
| B9: Round-Robin | 0.078 | 0.030 | 0.193 | 0.042 | 0.361 | **0.141** |
| B10: Sent-Length | 0.052 | 0.134 | 0.064 | 0.147 | 0.320 | **0.143** |
| B11: Optimal-Const | 0.352 | 0.294 | 0.181 | 0.285 | 0.432 | **0.309** |
| B12: Enhanced-Grep | 0.122 | 0.792 | 0.608 | 0.827 | 0.944 | **0.659** |
| B13: Gold-Density | 0.079 | 0.310 | 0.178 | 0.227 | 0.460 | **0.251** |
...
| B9: Round-Robin | 0.067 | 0.024 | 0.101 | 0.089 | 0.179 | **0.092** |
| B10: Sent-Length | 0.040 | 0.055 | 0.030 | 0.109 | 0.226 | **0.092** |
| B11: Optimal-Const | 0.264 | 0.201 | 0.113 | 0.416 | 0.290 | **0.257** |
| B12: Enhanced-Grep | 0.120 | 0.684 | 0.439 | 0.779 | 0.933 | **0.591** |
| B13: Gold-Density | 0.078 | 0.275 | 0.141 | 0.208 | 0.344 | **0.209** |
...
- **teastore**: Round-Robin F1=0.030, Sent-Length F1=0.134 (TransArc=0.829)
- **teammates**: Round-Robin F1=0.193, Sent-Length F1=0.064 (TransArc=0.821)
- **bigbluebutton**: Round-Robin F1=0.042, Sent-Length F1=0.147 (TransArc=0.831)
...
| B9: Round-Robin | 0.141 | 0.092 | +0.049 |
| B10: Sent-Length | 0.143 | 0.092 | +0.052 |
| B11: Optimal-Const | 0.309 | 0.257 | +0.052 |
| B12: Enhanced-Grep | 0.659 | 0.591 | +0.068 |
| B13: Gold-Density | 0.251 | 0.209 | +0.042 |
...
| 8 | B13: Gold-Density | 0.251 | SAM-CODE gold file frequency |
| 9 | B10: Sent-Length | 0.143 | Word count only |
| 10 | B9: Round-Robin | 0.141 | None (positional) |
