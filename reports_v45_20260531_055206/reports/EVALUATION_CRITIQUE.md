...
|---------|----------|-----|-----|--------|
| mediastore | 0.588 | 0.838 | 0.965 | 0.000 |
| teastore | 0.829 | 0.837 | 0.829 | 0.000 |
| teammates | 0.821 | 0.795 | 0.618 | 0.000 |
| bigbluebutton | 0.831 | 0.834 | 0.789 | 0.000 |
| jabref | 0.943 | 0.943 | 0.916 | 0.000 |
| **Average** | **0.803** | **0.849** | **0.823** | **0.000** |

**Decision-level F1** (one raw gold entry = one data point):

| Project | TransArc | V45 | LLM | V87-pc |
|---------|----------|-----|-----|--------|
| mediastore | 0.568 | 0.832 | 0.964 | N/A |
| teastore | 0.824 | 0.711 | 0.685 | N/A |
| teammates | 0.564 | 0.453 | 0.442 | N/A |
| bigbluebutton | 0.629 | 0.611 | 0.693 | N/A |
| jabref | 0.394 | 0.394 | 0.239 | N/A |
| **Average** | **0.596** | **0.600** | **0.604** | N/A |

**Component-level F1** (sentence × component pairs):

| Project | TransArc | V45 | LLM | V87-pc |
|---------|----------|-----|-----|--------|
| mediastore | 0.642 | 0.896 | 0.971 | N/A |
| teastore | 0.828 | 0.746 | 0.803 | N/A |
| teammates | 0.648 | 0.503 | 0.531 | N/A |
| bigbluebutton | 0.574 | 0.546 | 0.775 | N/A |
| jabref | 0.880 | 0.880 | 0.875 | N/A |
| **Average** | **0.714** | **0.714** | **0.791** | N/A |
...
| mediastore | 0.568 | 0.832 | 0.964 | N/A |
| teastore | 0.824 | 0.711 | 0.685 | N/A |
| teammates | 0.562 | 0.450 | 0.442 | N/A |
| bigbluebutton | 0.623 | 0.607 | 0.689 | N/A |
| jabref | 0.394 | 0.394 | 0.239 | N/A |
| **Average** | **0.594** | **0.599** | **0.604** | N/A |
...
| Project | File F1 | Decision F1 | Component F1 | Weighted F1 |
|---------|---------|-------------|-------------|-------------|
| mediastore | 0.838 | 0.832 | 0.896 | 0.832 |
| teastore | 0.837 | 0.711 | 0.746 | 0.711 |
| teammates | 0.795 | 0.453 | 0.503 | 0.450 |
| bigbluebutton | 0.834 | 0.611 | 0.546 | 0.607 |
| jabref | 0.943 | 0.394 | 0.880 | 0.394 |
| **Average** | **0.849** | **0.600** | **0.714** | **0.599** |
...
|--------|----------|-----|-----|--------|------|
| File F1 | 0.803 | 0.849 | 0.823 | 0.000 | V45 |
| Decision F1 | 0.596 | 0.600 | 0.604 | N/A | LLM |
| Component F1 | 0.714 | 0.714 | 0.791 | N/A | LLM |
| Weighted F1 | 0.594 | 0.599 | 0.604 | N/A | LLM |

**Per-project winners (File F1):**

| Project | TransArc | V45 | LLM | V87-pc | Best |
|---------|----------|-----|-----|--------|------|
| mediastore | 0.588 | 0.838 | 0.965 | 0.000 | LLM |
| teastore | 0.829 | 0.837 | 0.829 | 0.000 | V45 |
| teammates | 0.821 | 0.795 | 0.618 | 0.000 | TransArc |
| bigbluebutton | 0.831 | 0.834 | 0.789 | 0.000 | V45 |
| jabref | 0.943 | 0.943 | 0.916 | 0.000 | TransArc |

**Per-project winners (Component F1) — most semantically meaningful:**

| Project | TransArc | V45 | LLM | Best |
|---------|----------|-----|-----|------|
| mediastore | 0.642 | 0.896 | 0.971 | LLM |
| teastore | 0.828 | 0.746 | 0.803 | TransArc |
| teammates | 0.648 | 0.503 | 0.531 | TransArc |
| bigbluebutton | 0.574 | 0.546 | 0.775 | LLM |
...
- **teastore**: File→V45, Dec→TransArc, Comp→TransArc, Weighted→TransArc
- **bigbluebutton**: File→V45, Dec→LLM, Comp→LLM, Weighted→LLM

**2/5** projects show a winner flip across metric granularities.
...
In **2/5** projects, changing the metric granularity flips which system wins.
