...
- Sentence 157: "common.util contains utility classes."
  - Code: `src/main/java/teammates/common/datatransfer/attributes/FeedbackSessionAttributes.java`
  - Via model element(s): Component: Common

- Sentence 158: "common.exceptions contains custom exceptions."
  - Code: `src/test/java/teammates/common/util/TimeHelperExtension.java`
  - Via model element(s): Component: Common
...
- Sentence 18: "Because nodejs was running on a single CPU core, having a 16 or 32 CPU core server for BigBlueButton..."
  - Code: `build/packages-template/bbb-html5/mongod_start_pre.sh`
...
- Sentence 12: "The client side subscribes to the published collections on the server side."
  - Code: `build/packages-template/bbb-graphql-server/opts-jammy.sh`
  - Via model element(s): Component: HTML5 Server

- Sentence 9: "The HTML5 server is built upon Meteor.js in ECMA2015 for communication between client and server and..."
  - Code: `build/packages-template/bbb-graphql-server/opts-jammy.sh`
  - Via model element(s): Component: HTML5 Server
...
- Sentence 18: "Because nodejs was running on a single CPU core, having a 16 or 32 CPU core server for BigBlueButton..."
  - Code: `bbb-graphql-server/install-hasura.sh`
  - Via model element(s): Component: HTML5 Server
...
- Sentence 59: "This allows others who are using voice conference systems other than FreeSWITCH to easily create the..."
  - Code: `akka-bbb-fsesl/src/main/java/org/bigbluebutton/freeswitch/voice/freeswitch/actions/ConferenceCheckRecordCommand.java`
  - Via model element(s): Component: FreeSWITCH

- Sentence 59: "This allows others who are using voice conference systems other than FreeSWITCH to easily create the..."
  - Code: `akka-bbb-fsesl/src/main/java/org/bigbluebutton/freeswitch/voice/IVoiceConferenceService.java`
  - Via model element(s): Component: FreeSWITCH
...
- Sentence 5: "The model represents the most important data structures (BibDatases, BibEntries, Events, and related..."
  - Code: `src/main/java/org/jabref/logic/exporter/Exporter.java`
  - Via model element(s): Component: logic

- Sentence 5: "The model represents the most important data structures (BibDatases, BibEntries, Events, and related..."
  - Code: `src/test/java/org/jabref/logic/pdf/search/indexing/PdfIndexerTest.java`
  - Via model element(s): Component: logic
...
- Sentence 32: "All salted hashes of passwords are also stored in the Database component."
  - Expected code: `mediastore.basic/src/edu/kit/ipd/sdq/mediastore/basic/exceptions/DbException.java`
...
- Sentence 25: "After the user calls the page to list all available audio files, AudioAccess creates a query that is..."
  - Expected code: `mediastore.ejb.mediaaccess/src/edu/kit/ipd/sdq/mediastore/ejb/mediaaccess/MediaAccessImpl.java`
  - Required bridging model(s): ['Component: MediaAccess']
  - Miss type: no_link
...
- Sentence 11: "It matches the provided product ID or UI name (the filename for images not representing a product an..."
  - Expected code: `services/tools.descartes.teastore.image/src/main/java/tools/descartes/teastore/image/setup/StorageRule.java`
  - Required bridging model(s): ['Component: ImageProvider']
  - Miss type: no_link

- Sentence 11: "It matches the provided product ID or UI name (the filename for images not representing a product an..."
  - Expected code: `services/tools.descartes.teastore.image/src/main/java/tools/descartes/teastore/image/cache/entry/ICachable.java`
  - Required bridging model(s): ['Component: ImageProvider']
  - Miss type: no_link
...
- Sentence 172: "Sub-packages contains x.testdriver, x.datatransfer, x.util, x.logic, x.storage, x.search, x.webapi, ..."
  - Expected code: `src/test/java/teammates/common/util/StringHelperTest.java`
  - Gold SAD-SAM models for sentence: NONE
  - Gold SAM-CODE models for code: ['Component: Common', 'Interface: Common']

- Sentence 52: "The Web API is protected by two layers of access control check."
  - Expected code: `src/main/java/teammates/ui/webapi/GateKeeper.java`
  - Gold SAD-SAM models for sentence: NONE
...
- Sentence 120: "In particular, it is reponsible for the following."
  - Expected code: `src/test/java/teammates/storage/api/AccountsDbTest.java`
  - Required bridging model(s): ['Component: Storage']
  - Miss type: no_link

- Sentence 78: "In particular, it is responsible for the following."
  - Expected code: `src/test/java/teammates/logic/core/FeedbackQuestionsLogicTest.java`
  - Required bridging model(s): ['Component: Logic']
  - Miss type: no_link
...
- Sentence 58: "We have extracted out the component that integrates with FreeSWITCH into it’s own application."
  - Expected code: `bbb-fsesl-client/deploy.sh`
  - Gold SAD-SAM models for sentence: ['Component: FreeSWITCH']
  - Gold SAM-CODE models for code: ['Interface: FSESL', 'Component: FSESL']
...
- Sentence 72: "A user can join the voice conference (running in FreeSWITCH) from the BigBlueButton HTML5 client or ..."
  - Expected code: `build/packages-template/bbb-html5/build.sh`
  - Required bridging model(s): ['Component: HTML5 Client']
  - Miss type: wrong_model

- Sentence 76: "Uploaded presentations go through a conversion process in order to be displayed inside the client."
  - Expected code: `build/packages-template/bbb-html5/workers-start.sh`
  - Required bridging model(s): ['Component: HTML5 Client']
  - Miss type: no_link
...
| 5 | SAD-SAM FP | Component: E2E | Sentence 189: "e2e.pageobjects contains abstractions of the pages..." | 123 |
...
| Rank | Type | Model Element | Link Target | Induced TransArc FPs |
|------|------|---------------|-------------|---------------------|
| 1 | SAD-SAM FP | Component: HTML5 Server | Sentence 68: "Kurento Media Server KMS is a media server that im..." | 24 |
| 2 | SAD-SAM FP | Component: HTML5 Server | Sentence 18: "Because nodejs was running on a single CPU core, h..." | 24 |
