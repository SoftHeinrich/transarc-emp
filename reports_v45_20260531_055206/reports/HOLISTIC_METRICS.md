...
| teammates | 0.753 | 0.902 | 0.821 | 0.753 | 0.601 | 0.668 | 0.451 | 0.542 | 0.469 | 0.051 | 0.596 | 0.095 |
...
- Worst 3 sentences by F1:
  - S28: F1=0.000 (TP=0, FP=0, FN=2, Gold=2) "Furthermore, it fetches a list of all available audio files...."
  - S9: F1=0.000 (TP=0, FP=0, FN=1, Gold=1) "Furthermore, it fetches audio files from a specific location (e.g., a ..."
...
- Worst 3 sentences by F1:
  ...
  - S28: F1=0.000 (TP=0, FP=0, FN=14, Gold=14) "It is trained using all existing orders...."
...
- Worst 3 sentences by F1:
  - S151: F1=0.000 (TP=0, FP=0, FN=1, Gold=1) "Attempt to update an entity that does not exist throws EntityDoesNotEx..."
  - S110: F1=0.000 (TP=0, FP=0, FN=1, Gold=1) "Invalid parameters throws InvalidParametersException...."
  - S119: F1=0.000 (TP=0, FP=71, FN=59, Gold=59) "It contains minimal logic beyond what is directly relevant to CRUD ope..."
...
- Worst 3 sentences by F1:
  ...
  - S4: F1=1.000 (TP=1929, FP=1, FN=0, Gold=1929) "We have JUnit tests to detect violations of the most crucial dependenc..."
