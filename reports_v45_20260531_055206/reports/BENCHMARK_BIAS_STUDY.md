...
- **mediastore**: 10 UMEs: Interface: IUserManagement, Component: Cache, Interface: IPackaging, Interface: IMediaAccess, Interface: IUserDB, Interface: IDB, Component: AudioWatermarking, Interface: IMediaManagement, Interface: IFacade, Interface: IDownload
- **teastore**: 13 UMEs: Interface: Recommender, Interface: ImageProvider, Interface: AuthCart, Component: OrderBasedRecommender, Component: PreprocessedSlopeOneRecommender, Interface: CartActions, Component: DummyRecommender, Component: PopularityBasedRecommender, Interface: Persistence, Interface: LoadBalancer, Interface: ProductActions, Interface: RecommenderStrategy, Component: SlopeOneRecommender
- **teammates**: 7 UMEs: Interface: Test Driver, Interface: Client, Interface: UI, Interface: E2E, Interface: Logic, Interface: Common, Interface: Storage
- **bigbluebutton**: 12 UMEs: Interface: Recording Service, Interface: BBB web, Interface: HTML5 Server, Interface: Redis DB, Component: Recording Service, Interface: Presentation Conversion, Interface: Redis PubSub, Interface: WebRTC-SFU, Interface: FreeSWITCH, Interface: HTML5 Client, Interface: FSESL, Interface: Apps
...
| 81 | `src/main/java/teammates/ui/` | 235 |
...
| 8 | Interface: IPackaging | Interface | 3 |
...
| 13 | Component: UserManagement | Component | 2 |
| 14 | Interface: IDB | Interface | 2 |
| 15 | Component: Facade | Component | 1 |
| 16 | Component: TagWatermarking | Component | 1 |
| 17 | Component: Reencoding | Component | 1 |
| 18 | Component: MediaManagement | Component | 1 |
| 19 | Component: Packaging | Component | 1 |
...
| 7 | Component: SlopeOneRecommender | Component | 2 |
| 8 | Component: DummyRecommender | Component | 2 |
| 9 | Component: OrderBasedRecommender | Component | 2 |
| 10 | Component: PreprocessedSlopeOneRecommender | Component | 2 |
| 11 | Component: PopularityBasedRecommender | Component | 2 |
| 12 | Interface: AuthCart | Interface | 2 |
| 13 | Interface: CartActions | Interface | 1 |
| 14 | Interface: RecommenderStrategy | Interface | 1 |
| 15 | Interface: Persistence | Interface | 1 |
| 16 | Interface: ImageProvider | Interface | 1 |
| 17 | Interface: Recommender | Interface | 1 |
| 18 | Interface: ProductActions | Interface | 1 |
| 19 | Interface: LoadBalancer | Interface | 1 |
...
| 3 | Interface: Common | Interface | 150 |
| 4 | Component: Common | Component | 150 |
...
| 9 | Interface: HTML5 Server | Interface | 16 |
...
| teastore | Component: Persistence | 6 | `ErrorServlet.java` | 6 |
| teammates | Component: Logic | 15 | `EmailSenderTest.java` | 19 |
| bigbluebutton | Component: HTML5 Client | 14 | `after-install.sh` | 20 |
| jabref | Component: model | 6 | `SpecialFieldValue.java` | 6 |
