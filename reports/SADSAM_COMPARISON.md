...
| dataset | TransArc | s_linker11 | s_linker13f |
|---|---|---|---|
| mediastore | **0.727** | **1.000** | **0.982** |
| teastore | **0.821** | **0.939** | **1.000** |
| teammates | **0.703** | **0.835** | **0.957** |
| bigbluebutton | **0.876** | **0.979** | **0.891** |
| jabref | **1.000** | **0.952** | **1.000** |
| **AVG** | **0.825** | **0.941** | **0.966** |
