...
| dataset | TransArc | s_linker11 | s_linker13f |
|---|---|---|---|
| mediastore | **0.516** | **0.897** | **0.916** |
| teastore | **0.806** | **0.941** | **1.000** |
| teammates | **0.927** | **0.883** | **0.979** |
| bigbluebutton | **0.850** | **0.902** | **0.886** |
| jabref | **0.915** | **0.977** | **1.000** |
| **AVG** | **0.803** | **0.920** | **0.956** |
