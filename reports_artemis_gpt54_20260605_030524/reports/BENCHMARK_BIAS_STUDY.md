...
- **mediastore**: 10 UMEs: Interface: IMediaAccess, Interface: IMediaManagement, Interface: IUserDB, Interface: IPackaging, Component: AudioWatermarking, Interface: IDB, Component: Cache, Interface: IUserManagement, Interface: IDownload, Interface: IFacade
- **teastore**: 13 UMEs: Component: SlopeOneRecommender, Interface: ProductActions, Interface: Recommender, Interface: RecommenderStrategy, Interface: LoadBalancer, Component: PreprocessedSlopeOneRecommender, Interface: CartActions, Interface: AuthCart, Interface: Persistence, Component: DummyRecommender, Component: PopularityBasedRecommender, Component: OrderBasedRecommender, Interface: ImageProvider
- **teammates**: 7 UMEs: Interface: Client, Interface: E2E, Interface: Test Driver, Interface: Storage, Interface: UI, Interface: Logic, Interface: Common
- **bigbluebutton**: 12 UMEs: Interface: FreeSWITCH, Interface: FSESL, Interface: WebRTC-SFU, Interface: Redis PubSub, Interface: HTML5 Client, Interface: Presentation Conversion, Component: Recording Service, Interface: Apps, Interface: HTML5 Server, Interface: Recording Service, Interface: Redis DB, Interface: BBB web
...
| 4 | `src/main/java/org/jabref/logic/` | 575 |
...
| 4 | Interface: IFacade | Interface | 3 |
| 5 | Component: AudioWatermarking | Component | 3 |
| 6 | Interface: IPackaging | Interface | 3 |
| 7 | Interface: IUserDB | Interface | 3 |
| 8 | Interface: IMediaManagement | Interface | 3 |
| 9 | Component: Cache | Component | 3 |
| 10 | Interface: IUserManagement | Interface | 3 |
| 11 | Component: UserDBAdapter | Component | 2 |
| 12 | Interface: IDB | Interface | 2 |
| 13 | Component: MediaAccess | Component | 2 |
| 14 | Component: UserManagement | Component | 2 |
| 15 | Component: Packaging | Component | 1 |
| 16 | Component: MediaManagement | Component | 1 |
| 17 | Component: Facade | Component | 1 |
| 18 | Component: Reencoding | Component | 1 |
...
| 8 | Component: SlopeOneRecommender | Component | 2 |
...
| 13 | Interface: ProductActions | Interface | 1 |
| 14 | Interface: Persistence | Interface | 1 |
| 15 | Interface: LoadBalancer | Interface | 1 |
| 16 | Interface: ImageProvider | Interface | 1 |
| 17 | Interface: RecommenderStrategy | Interface | 1 |
| 18 | Interface: Recommender | Interface | 1 |
| 19 | Interface: CartActions | Interface | 1 |
...
| 10 | Interface: HTML5 Server | Interface | 16 |
| 11 | Component: HTML5 Server | Component | 16 |
| 12 | Interface: HTML5 Client | Interface | 16 |
...
| 21 | Interface: Redis DB | Interface | 3 |
| 22 | Component: Redis DB | Component | 3 |
...
|---------|--------------------------|-------|----------------------|-------|
| mediastore | Component: DB | 7 | `UserAlreadyExistsException.java` | 7 |
| teastore | Component: WebUI | 6 | `OrderItemRepository.java` | 6 |
| teammates | Component: Logic | 15 | `EmailGenerator.java` | 19 |
| bigbluebutton | Component: HTML5 Client | 14 | `run-dev.sh` | 20 |
| jabref | Component: model | 6 | `ParsedEntryLink.java` | 6 |
